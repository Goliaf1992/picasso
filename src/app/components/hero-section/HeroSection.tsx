...
const HeroSection = () => {
  return (
    <section
      className="bg-gradient-to-r from-[var(--color-gradient-start)] to-[var(--color-gradient-end)] w-full px-4 sm:px-6 lg:px-8 py-20 text-center h-auto min-h-screen flex flex-col items-center z-40 justify-around relative rounded-[0%_0%_30%_30%_/_30%_30%_40px_40px] 
